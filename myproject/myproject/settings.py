...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'restourancite' / 'templates'],  # Укажите путь к папке шаблонов
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'restourancite' / 'templates'],
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'Restouran',
        'USER': 'postgres',
        'PASSWORD': 'nirzzii228777',
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
